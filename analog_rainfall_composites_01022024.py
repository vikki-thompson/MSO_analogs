...
max_past = gdata.composite_max_dates(pr_past, dates_past)
max_present = gdata.composite_max_dates(pr_present, dates_present)
...
axs[0,0].set_title('ERA-5')
axs[0,1].set_title('KNMI-LENTIS')
